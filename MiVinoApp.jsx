...
export default function MiVinoApp() {
  ...
  const handleAddWine = () => {
    ...
    if (vintage < 1800 || vintage > new Date().getFullYear()) {
    ...
    setWines([...wines, { ...newWine, vintage, price, id: Date.now() }]);
  ...
  const handleScanWine = () => {
    ...
    setWines([...wines, { name, vintage: 2020, price: 50, id: Date.now() }]);
  };
      ...
      <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '20px' }}>
          ...
          <div style={{ background: '#1e293b', padding: '20px', borderRadius: '8px', border: '1px solid #6d28d9', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '28px', fontWeight: 'bold', margin: 0, color: '#22c55e' }}>
              ${wines.reduce((sum, w) => sum + (w.price || 0), 0).toFixed(0)}
            </p>
          </div>
          <div style={{ background: '#1e293b', padding: '20px', borderRadius: '8px', border: '1px solid #6d28d9', textAlign: 'center' }}>
